...
import constants
from DataProcessing import StartingDataset
from StartingCNN import StartingCNN
...
def main():
    ...
    # NOTE: I think this is for tensorboard?, we should probably change 'data' to a specific term for the dataset.
    label = f"data_{int(time.time())}"
